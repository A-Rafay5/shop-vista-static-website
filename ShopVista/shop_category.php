    ...
    <section class="section-margin calc-60px">
      <div class="container">
        <div class="section-intro pb-60px">
          ...
          <h2><span class="section-intro__style">Trending Categories</span></h2>
        </div>
        <div class="row">
			 <?php
						...
						{
							$productid=$_GET["c_id"];
							$exe = mysqli_query($connect,"select p.pro_id,p.pro_code,p.pro_name,p.pro_des,p.pro_price,p.pro_image,p.pro_qty,c.cat_name  from producttable as p  inner join  categorytable as c on c.cat_id  = p.cat_id_fk  WHERE cat_id=$productid");
